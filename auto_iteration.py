...
#csv 파일 가져오기
#csv 파일 첫 번째 행: 의미 없는 열 번호
#csv 파일 두 번째 행: 재사용하지 않은 원래 물성치 및 각도
data_p = np.loadtxt('recycled_parameter.csv', delimiter=',', skiprows=1)
...
#------Visualization------
#Setting file location to current directory
current_directory = os.getcwd()
file_path = os.path.join(current_directory, job_name + '.odb')
...
a = mdb.models['Model-1'].rootAssembly
session.viewports['Viewport: 1'].setValues(displayedObject=a)
o3 = session.openOdb(name=file_path)
